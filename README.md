...
- include theme stylings: 	**bubble.css, snow.css and core.css of quilljs** in your index.html (you can find them in `node_modules/dist`), or add them in your css/scss files  with `@import` statements, or add them external stylings in your build process.
